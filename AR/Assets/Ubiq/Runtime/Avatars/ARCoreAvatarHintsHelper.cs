...
namespace Ubiq.Avatars
{
    ...
    public class ARCoreAvatarHintsHelper : MonoBehaviour
    {
        ...
        private void Start()
        {
            var pc = GameObject.Find("AR Session Origin");
            ...
            SetTransformProvider(headPositionNode, headRotationNode, pc.GetComponentInChildren<Camera>()?.transform);
        }
